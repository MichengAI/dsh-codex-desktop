...
test('sandbox preload 的 IPC 字面量与主契约保持一致', async () => {
  ...
  assert.deepEqual(channelLiterals(dsh), [SHELL_IPC.dshAction, SHELL_IPC.dshLocale, SHELL_IPC.dshNotification, SHELL_IPC.dshNotificationReply, SHELL_IPC.dshOpenSession, SHELL_IPC.dshSettingsVisibility, SHELL_IPC.dshState, SHELL_IPC.dshTheme].sort())
})
